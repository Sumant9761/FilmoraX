# 🎬 FilmoraX (AI Movie Recommendation Platform)

FilmoraX is a modern, responsive, Netflix-inspired movie streaming interface enhanced with **AI-powered movie recommendations**. The application integrates GPT-based natural language understanding with real-time movie data from TMDB, allowing users to discover movies intelligently using simple prompts.
